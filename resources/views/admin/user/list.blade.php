...
<h1>משתמשים</h1>
<a href="{{url('admin/users/create')}}" class="btn btn-primary float-right mb-3">הוסף משתמש חדש</a>
            ...
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="open-modal" data-name="{{$user->name}}"  data-id="{{$user->id}}" href="" data-toggle="modal" data-target="#confirmModal">
