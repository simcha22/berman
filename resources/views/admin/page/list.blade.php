...
<h1>עמודים</h1>
<a href="{{url('admin/pages/create')}}" class="btn btn-primary float-right mb-3">הוסף עמוד חדש</a>
@if($pages->isEmpty())
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="align-middle">
                    ...
                    <a class="open-modal" data-name="{{$page->name}}"  data-id="{{$page->id}}" href="" data-toggle="modal" data-target="#confirmModal">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">מחיקת קטגוריה</h5>
